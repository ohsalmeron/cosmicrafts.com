/**
 * Cosmicrafts WOU-ID Client SDK
 * (C) 2026 World of Unreal / Cosmicrafts. MIT License.
 */
...
export class WouAuthClient {
  ...
  constructor(defaultContext: GameContext = 'cosmicrafts') {
...
export const wouAuth = new WouAuthClient('cosmicrafts');
