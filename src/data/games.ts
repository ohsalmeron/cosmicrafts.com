...
export const GAMES: Game[] = [
  {
    ...
    tag: 'NEW',
    tagColor: 'emerald',
    description: 'Space drifting procedural. Derrapa entre sectores, encadena drift y sobrevive al Dark Rift.',
    image: '/assets/planet.webp',
    status: 'playable',
    statusLabel: 'Jugable',
    embed: 'https://stardrifter.cosmicrafts.com/',
    playRoute: '/play/stardrifter',
    repo: 'https://github.com/cosmicrafts/Star-Drifter',
    features: ['Drift', 'JavaScript', 'Arcade'],
    badge: 'New',
    badgeClass: 'new',
    genre: 'Arcade Drift',
